...
* **Tailscale:** [Download Here](https://tailscale.com/download) (Required for secure networking)
* **Sunshine:** [Download Here](https://github.com/LizardByte/Sunshine/releases) (Required for low-latency streaming)
* **Python 3.x:** [Download Here](https://www.python.org/downloads/) (Required for the audio engine)
...
1.  **Download the Source Code:** (Code -> Download ZIP) and extract it.
2.  **Install Python Dependencies:** Open the `src` folder, right-click and select "Open Terminal Here" (or use Command Prompt). Run:
    ```powershell
    pip install pedalboard
    ```
3.  **Build the App:** Go back to the root folder and double-click `BUILD_APP.bat`.
...
1.  Right-click `WormholeConsole.exe`.
2.  Select **Run as Administrator**.
3.  The console will launch in "Standby" mode.
...
* Paste this into the location box:
    ```cmd
    schtasks /run /tn "WormholeLauncher"
    ```
